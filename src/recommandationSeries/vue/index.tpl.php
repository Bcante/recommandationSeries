        ...
        <md-sidenav layout="column" md-component-id="right" md-is-locked-open="true" class="md-sidenav-right" md-whiteframe="2">
            <div ng-show="!connected" class="menu">
                ...
                <md-whiteframe ng-repeat="popularSerie in popularSeries" flex-sm="45" flex-gt-sm="35" flex-gt-md="25" layout layout-align="center center">
                    <span class="sideserie" ng-click="displayASerie(popularSerie.id)" onclick="window.top.window.scrollTo(0,0);">
            ...
            <div ng-show="connected" class="menu">
                ...
                <md-whiteframe ng-repeat="recommandationSerie in recommandationsSeries track by $index" flex-sm="45" flex-gt-sm="35" flex-gt-md="25" layout layout-align="center center">
                    <span class="sideserie" ng-click="displayASerie(recommandationSerie.id)" onclick="window.top.window.scrollTo(0,0);">
